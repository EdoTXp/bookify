...
abstract class IsbnVerifierHelper {
  IsbnVerifierHelper._();
  ...
  static String? verifyIsbn(String value) {
  ...
  static bool _validateIsbn10(String value) {
    if (value.length == 10) {
      int result = 0;
      int multiple = 10;
  ...
  static bool _validateIsbn13(String value) {
    if (value.length == 13) {
      int result = 0;
