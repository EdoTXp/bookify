...
class UserHourTimeModel {
  ...
  factory UserHourTimeModel.fromMap(Map<String, dynamic> map) {
    return UserHourTimeModel(
      repeatHourTimeType: RepeatHourTimeType.toType(map['repeatHourTimeType'] as int),
  ...
  factory UserHourTimeModel.fromJson(String source) => UserHourTimeModel.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  bool operator ==(covariant UserHourTimeModel other) {
    ...
    return 
      other.repeatHourTimeType == repeatHourTimeType &&
