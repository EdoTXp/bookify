...
abstract class AppTheme {
  ...
  static final appDarkTheme = ThemeData(
    appBarTheme: _appBarTheme.copyWith(
      systemOverlayStyle: const SystemUiOverlayStyle(
        ...
        systemNavigationBarDividerColor: AppColor.bookifyDarkBackgroundColor,
  ...
  static const _searchBarTheme = SearchBarThemeData(
  ...
  static const _segmentedButtonTheme = SegmentedButtonThemeData(
    style: ButtonStyle(
  ...
  static const _iconTheme = IconThemeData(color: AppColor.bookifyPrimaryColor);
  ...
  static const _radioTheme = RadioThemeData(
  ...
  static TextStyle _resolveInputLabelStyle(Set<WidgetState> states) {
  ...
  static final _inputDecorationTheme = InputDecorationTheme(
    ...
    floatingLabelStyle: WidgetStateTextStyle.resolveWith(
      _resolveInputLabelStyle,
    ),
  );

  static const _bottomAppBarThemeData = BottomAppBarThemeData();
