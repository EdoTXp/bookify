...
void main() {
  ...
  group('Test normal CRUD of bookcase/book without error ||', () {
    test('get bookcase/book relationships', () async {
      ...
      final bookOnCaseRelationship = await bookOnCaseRepository
          .getBooksOnCaseRelationship(bookcaseId: 1);
    ...
    test('getBookIdForImagePreview when bookId is null', () async {
      ...
      final bookId = await bookOnCaseRepository.getBookIdForImagePreview(
        bookcaseId: 3,
      );
    ...
    test('insert relationship', () async {
      ...
      final relationshipRowInserted = await bookOnCaseRepository.insert(
        bookcaseId: 1,
        bookId: '1',
      );
    ...
    test('countBookcasesByBook', () async {
      ...
      final bookcasesCount = await bookOnCaseRepository.countBookcasesByBook(
        bookId: 'bookId',
      );
