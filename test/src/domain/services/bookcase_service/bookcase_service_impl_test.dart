...
void main() {
  ...
  group('test normal CRUD of complete book without error ||', () {
    ...
    test('getBookcasesByName()', () async {
      ...
      final bookcaseModel = await bookcaseService.getBookcasesByName(
        name: 'name',
      );
    ...
    test('getAllBookcaseRelationships()', () async {
      when(
        () => bookOnCaseRepository.getBooksOnCaseRelationship(
      ...
      final bookcasesRelationships = await bookcaseService
          .getAllBookcaseRelationships(bookcaseId: 1);
    ...
    test('getBookIdForImagePreview()', () async {
      when(
        () => bookOnCaseRepository.getBookIdForImagePreview(
          bookcaseId: any(named: 'bookcaseId'),
        ),
      ).thenAnswer((_) async => 'bookId');

      final bookId = await bookcaseService.getBookIdForImagePreview(
        bookcaseId: 1,
      );
    ...
    test('getBookcaseById()', () async {
      ...
      final bookcaseModel = await bookcaseService.getBookcaseById(
        bookcaseId: 1,
      );
    ...
    test('insertBookcase()', () async {
      ...
      final newBookcaseId = await bookcaseService.insertBookcase(
        bookcaseModel: bookcases[0],
      );
    ...
    test('updateBookcase()', () async {
      ...
      final bookcaseRowUpdated = await bookcaseService.updateBookcase(
        bookcaseModel: bookcases[0],
      );
    ...
    test('deleteBookcase()', () async {
      ...
      final bookcaseRowDeleted = await bookcaseService.deleteBookcase(
        bookcaseId: 1,
      );
